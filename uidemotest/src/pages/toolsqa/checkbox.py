...
class CheckboxPage(CheckboxPageLocator):
    ...
    def click_home_checkbox_label(self):
        self.sl.wait_and_click(self.HOME_LABEL)
        return self

    def is_home_checkbox_checked(self):
        home_checkbox = self.sl.wait.until(EC.presence_of_element_located(self.HOME_CHECKBOX))
        return home_checkbox.is_selected()

    def get_result_message(self):
        try:
            return self.sl.get_text(self.RESULT_MSG)
